...
const char* s_labelMemorySpanCount = "Memory Span Count:";
...
void DemoOptions::InitMemorySettings()
{
	...
	newToggle = new ToggleControl(*this);
	newToggle->SetLabel(s_labelMemorySpanCount);
	newToggle->AddOption("Small", (void*)AkSpanCount_Small);
	newToggle->AddOption("Medium", (void*)AkSpanCount_Medium);
	newToggle->AddOption("Huge", (void*)AkSpanCount_Huge);
	newToggle->SetSelectedIndex(memSettings.uVMSpanCount);
	newToggle->SetDelegate((PageMFP)&DemoOptions::InitSettings_Changed);
	m_Controls.push_back(newToggle);
}
...
void DemoOptions::InitSettings_Changed(void* in_pSender, ControlEvent* in_pControlEvent)
{
	...
	memSettings.uVMSpanCount = (AkSpanCount)(AkUIntPtr)((ToggleControl*)FindControl(s_labelMemorySpanCount))->SelectedValue();
	memSettings.uDeviceSpanCount = (AkSpanCount)(AkUIntPtr)((ToggleControl*)FindControl(s_labelMemorySpanCount))->SelectedValue();
